...
function Banner() {
  return (
    <>
      ...
      <div className="container p-0 position-relative mt-0 mt-md-5 brandsOuterDiv" style={{height:'300px'}} >
          ...
          <div className='col-lg-9 col-md-12 col-sm-12 col-12 mx-auto'>
              <div className='mt-5 w-100 position-relative' > 
                <div className='w-100 d-flex justify-content-center justify-content-md-start'>
                  <div className=''>
                    <p className='position-relative '>Discover What’s Trending – <br /><span className='fw-bold fs-2' style={{color: '#b17659'}}>Shop the Look. <FontAwesomeIcon icon={faTag} /></span></p>
